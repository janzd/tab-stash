...
for (const file of [manifest.background.service_worker, ...Object.values(manifest.icons), 'library.html', 'library.js', 'theme.js', 'themes.css', 'styles.css', 'palettes.js', manifest.options_ui.page, 'settings.js', 'settings.css', 'preview-cache.js', 'recovery.html', 'recovery.js', 'recovery-settings.js', 'recovery-service.js', 'recovery-db.js', 'recovery-model.js', 'recovery-restore.js']) {
