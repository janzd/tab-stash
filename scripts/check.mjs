...
for (const file of [manifest.background.service_worker, ...Object.values(manifest.icons), 'library.html', 'library.js', 'theme.js', 'themes.css', 'styles.css', 'palettes.js', manifest.options_ui.page, 'settings.js', 'settings.css', 'preview-cache.js']) {
